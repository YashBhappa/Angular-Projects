...
public class FlightCriteria {
	...
	public FlightCriteria(CompanyName company, FlightType flightType, TravelType travelType, String departureLocation,
			...
			LocalTime flightDurationMax, String aircraftType, LocalDate departureDateMin, LocalDate arrivalDateMin,
			LocalDate backDateMin, LocalTime departureTimeMin, LocalTime arrivalTimeMin, LocalTime backTimeMin,
			LocalDate departureDateMax, LocalDate arrivalDateMax, LocalDate backDateMax, LocalTime departureTimeMax,
